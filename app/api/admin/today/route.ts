 ...
 * read of the day, in one request: what happened overnight, which issues are
 * spiking, and what is actually waiting on a human.
 *
...
import { getOutcomes, listReplyDrafts, listMonetApprovals, getDailyRollup } from "@/lib/kv";
import { listArticles, countByState, type ArticleState } from "@/lib/kb-store";
import { topicTrends, ticketRecords, type TopicTrend } from "@/lib/topics";
import { gapList } from "@/lib/analytics";
