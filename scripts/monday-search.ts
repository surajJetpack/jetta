...
async function main() {
  ...
  if (r[0]) {
    await addPlusOne({
      itemId: r[0].id,
      ticketUrl: "https://jetpackwork.freshdesk.com/a/tickets/99999",
      product: "getsign",
      symptom: "signed documents never reach the board's file column",
      accountLabel: "script-test@example.com",
    });
