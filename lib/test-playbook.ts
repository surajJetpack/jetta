...
export const PLAYBOOK_RULES: string[] = [
  ...
  "Give your real name and work email when Jetta asks for them — that is how we find and clean up your conversations. (If you ever email support as part of a test, start the subject with [TEST].)",
  "Use an email address you can read: ticket replies and notifications land there, and checking they arrive is part of several scenarios.",
...
export const PLAYBOOK_CLEANUP: PlaybookCheck[] = [
  ...
  { id: "cu-chats", text: "Your chat conversations are resolved (Jetta may have done this for you — check the Chats tab)." },
...
const CHAT_TRACK: PlaybookTrack = {
  id: "chat",
  label: "Live chat",
  ...
  scenarios: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Open the Chats tab and find your live-chat conversations; read one transcript end to end." },
      ...
      checks: [
        { id: "c1", text: "The Chats tab shows your live-chat conversations with full transcripts, including the human-takeover one." },
